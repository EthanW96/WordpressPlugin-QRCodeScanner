...
class QRCodeTracker_Admin {
    ...
    public function admin_page() {
        ...
        foreach ($entries as $row) {
            ...
            echo "<a href='$christmas_download_url' class='button button-primary' target='_blank' rel='noopener noreferrer' aria-label='Export Merry Christmas QR (opens in new tab)'>Export Merry Christmas QR</a> ";
            if ($row->scan_count > 0) {
